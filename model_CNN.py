...
path1 = 'C:/Users/Trupti/Downloads/archive (7)/real_and_fake_face_detection/real_and_fake_face/training_fake'    #path of folder of images    
path2 = 'E:/100% Code/24SS426-Morphing/Morphing/testing/1'  #path of folder to save images    
